        ...
        <div class="container">
            ...
            <div class="row pb-3">
                ...
                <div class="col-lg-3">
                    <div class="cat-card">
                        <div class="left">
                            <img src="{{ asset('front-assets/images/cat-3.jpg')}}" alt="" class="img-fluid">
                        </div>
                        <div class="right">
                            <div class="cat-data">
                                <h2>Mens</h2>
                ...
                <div class="col-lg-3">
                    <div class="cat-card">
                        <div class="left">
                            <img src="{{ asset('front-assets/images/cat-4.jpg')}}" alt="" class="img-fluid">
                        </div>
                        <div class="right">
                            <div class="cat-data">
                                <h2>Mens</h2>
        ...
        <div class="container">
            ...
            <div class="row pb-3">
                ...
                <div class="col-md-3">
                    <div class="card product-card">
                        <div class="product-image position-relative">
                            <a href="" class="product-img"><img class="card-img-top" src="{{ asset('front-assets/images/product-6.jpg')}}" alt=""></a>
                            <a class="whishlist" href="222"><i class="far fa-heart"></i></a>                            
